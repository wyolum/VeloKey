/*    ClickButton
 ...
 Returned click counts:
   ...
   A positive number denotes the number of (short) clicks after a 
   released button
...
NOTE!
 ...
 2013.08.29 - Some small clean-up of code, more sensible variable names etc.
                Added another example code for multiple buttons in an object 
                array
...
void ClickButton::Update()
{
  ...
  // If the switch changed, due to noise or a button press, 
  ...
  // If the button released state is stable, report nr of clicks and start 
  // new cycle
